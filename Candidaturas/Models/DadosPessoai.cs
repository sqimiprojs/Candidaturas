...
namespace Candidaturas.Models
{
    ...
    public partial class DadosPessoai
    {
        ...
        public int DistritoNatural { get; set; }
        public int ConcelhoNatural { get; set; }
        public int FreguesiaNatural { get; set; }
        ...
        public int DistritoMorada { get; set; }
        public int ConcelhoMorada { get; set; }
        public int FreguesiaMorada { get; set; }
